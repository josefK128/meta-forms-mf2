System.register(['reflect-metadata', 'angular2/core', 'angular2/platform/browser', './components/producer-component.js', './mf-config.js', 'es6-promise'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, browser_1, producer_component_js_1, mf_config_js_1, es6_promise_1;
    var i, Narrative;
    return {
        setters:[
            function (_1) {},
        ...
        execute: function() {
            ...
            Narrative = (function () {
                ...
                Narrative.prototype.index = function () {
                    return this.count;
                };
            ...
            //});
            Narrative['instance'] = function () {
                return new es6_promise_1.default.Promise(function (resolve, reject) {
                    browser_1.bootstrap(Narrative).then(function (narrative) {
