System.register(['angular2/testing', 'angular2/core', '../../../app/modules/mf-config.js', '../../../app/modules/components/producer-component.js'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var testing_1, testing_2, core_1, mf_config_js_1, producer_component_js_1;
    var axiom1, axiom2, genotype1, genotype2, expect_genotype1, expect_phenotype1, expect_genotype2, expect_phenotype2;
    function main() {
        var producer = new producer_component_js_1.Producer(mf_config_js_1.CONFIG);
        ...
        testing_1.describe('producer-component-e2e-spec', function () {
            ...
            testing_2.beforeEach(function () {
                ...
                producer = new producer_component_js_1.Producer(mf_config_js_1.CONFIG);
            });
    ...
    return {
        ...
        execute: function() {
            axiom1 = { axiom: [2, 4],
                ...
                g_rule: '*',
                p_rule: 2.0,
                genotype: 15 }, expect_genotype1 = 6, expect_phenotype1 = 3, expect_genotype2 = 15, expect_phenotype2 = 30;
        }
    }
});
